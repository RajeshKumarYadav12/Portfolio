      ...
      {!showSplash && (
        ...
        >
          ...
          <nav
            className={cn(
              ...
              theme === "dark"
                ...
                : "bg-alice-blue/50 border-black/10",
            )}
          >
            ...
            <button
              ...
              className={cn(
                ...
                theme === "dark"
                  ...
                  : "bg-white-smoke text-indigo-600",
              )}
            >
              {theme === "dark" ? (
          ...
          <main className="relative z-10">
            ...
            <section
              id="hero"
              className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 text-center pt-24 md:pt-0"
            >
              <motion.h1
              ...
              >
                ...
                <a
                  href="https://drive.google.com/file/d/1e-KJsU-S-4pLX846g614A2vbSEqsu9-d/view?usp=sharing"
                  target="_blank"
                  ...
                  className={cn(
                    ...
                    theme === "dark"
                      ...
                      : "bg-white-smoke border-black/10 hover:bg-black/10",
                  )}
                >
              ...
              >
                <a
                  href={portfolioData.basics.links.github}
                  target="_blank"
                  className={cn(
                ...
                <a
                  href={portfolioData.basics.links.linkedin}
                  target="_blank"
                  className={cn(
                    "transition-colors cursor-pointer",
                    theme === "dark"
            ...
            >
              <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
                {portfolioData.achievements.slice(0, 4).map((stat, i) => (
                  ...
                  >
                    <div className="text-2xl md:text-4xl font-black text-emerald-500 mb-1">
                      {stat.value}
                    </div>
                    <div
                      className={cn(
            ...
            <section
              id="experience"
              className="py-16 md:py-32 px-4 sm:px-6 max-w-5xl mx-auto"
            >
                ...
                {portfolioData.experience.map((exp, i) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col md:flex-row md:items-start justify-between gap-3 mb-4">
                      <div>
                        <h3 className="text-lg font-black group-hover:text-emerald-500 transition-colors">
                          {exp.role}
                        </h3>
                        <div
                          className={cn(
                    ...
                    <motion.div
                      ...
                      className={cn(
                        ...
                        theme === "dark"
                          ...
                          : "bg-white-smoke border-black/5 shadow-xl shadow-black/5 hover:border-emerald-500/50",
                      )}
                    >
            ...
            <section
              id="projects"
              className="py-16 md:py-32 px-4 sm:px-6 max-w-7xl mx-auto"
            >
              <div className="flex items-center gap-4 mb-16">
                <div className="p-3 rounded-2xl bg-emerald-500/10 border border-emerald-500/20">
                  ...
                  <motion.div
                    ...
                    className={cn(
                      ...
                      theme === "dark"
                        ...
                        : "bg-white-smoke border-black/5 shadow-2xl shadow-black/5",
                    )}
                  >
                    <div className="aspect-video overflow-hidden">
                      <img
                        src={
                          [trafficImg, skilloImg, digitalSafeImg, movieImg][i]
                        }
                        alt={project.title}
                    ...
                    >
                      ...
                      <div className="flex flex-wrap gap-2 mt-3">
                        {project.stack.slice(0, 4).map((tech, j) => (
                          <span
                            key={j}
                            className="text-[10px] font-mono text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded border border-emerald-500/20"
                          >
                            {tech}
                          </span>
                        ))}
                    ...
                    ([category, skills], i) => (
                      <motion.div
                        ...
                        className={cn(
                          ...
                          theme === "dark"
                            ? "bg-white/[0.03] border-white/10"
                            : "bg-white-smoke border-black/5 shadow-xl shadow-black/5",
                        )}
                      >
                        <h3 className="text-emerald-500 font-mono text-xs uppercase tracking-widest mb-6 font-bold">
                          {category}
                        </h3>
                          ...
                          {skills.map((skill, j) => (
                            <span
                              ...
                              className={cn(
                                ...
                                theme === "dark"
                                  ? "bg-white/5 border-white/10 text-white/60 hover:bg-emerald-500/10 hover:border-emerald-500/30"
                                  : "bg-mint-cream border-black/5 text-slate-600 hover:bg-emerald-500/10 hover:border-emerald-500/30",
                              )}
                            >
                              {skill}
                            </span>
            ...
            <section id="contact" className="py-16 md:py-32 px-4 sm:px-6">
              <div className="max-w-5xl mx-auto">
                ...
                >
                  ...
                  want to say hello? Fill in the form below and I'll respond as
                  soon as possible.
                </motion.p>
              ...
              <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-center gap-12 mb-12">
                  <div className="text-center md:text-left">
                    ...
                    >
                      Building high-performance digital experiences with
                      ...
                      <a
                        ...
                        className={cn(
                          ...
                          theme === "dark"
                            ...
                            : "bg-white-smoke text-slate-400 hover:text-slate-900 hover:bg-black/10",
                        )}
                      >
                ...
                >
                  ...
                  >
                    © {new Date().getFullYear()} Rajesh Kumar Yadav. All rights
                    reserved.
                  </p>
